...
pc = T * p0';
pc'
%% HM2 - plotting position of end-effector
T=transl([-0.5 1.5 0]);
% for config elbow up
...
%% HM3 - Rotation and translation of pe
...
figure;
plot(dx,qs)
%% HM4 - inverse kinematics w/ joint limits
qs2 = r2dp.ikcon(Ts);
%plots
...
%% HM7 - Calculate the gravity load and plot against joint torque
